...
#define РАЗМЕР_ПАКЕТНОЙ_ОТПРАВКИ 512 // Сколько пакетов в одном системном вызове. Вот где мощь.
#define РАЗМЕР_БУФЕРА_СОКЕТА (32 * 1024 * 1024) // 8 МБ. Забиваем канал до отказа.
